...
def write2file(dict, numb_nuc, numb_reads, outputfile):
    ...
    with open(outputfile, "w") as csvfile:
        ...
        for k, v in od.iteritems():
            percentage = round((float(v / numb_nuc) * 100), 3)
...
parser.add_argument(dest='qualities_file', metavar='454 qualities file', nargs=1,
...
if __name__ == "__main__":
    ...
    print("Writing the output to ", args.output_file )
    write2file(dict, numb_nuc, numb_reads, args.output_file)