...
def processGff(gff):
    ...
    with open(gff, 'r') as infile:
        ...
        logging.info("\n################################\n")
        logging.info("Number of genes without start codon\t%i" %len(nostart))
        ...
        logging.info("Number of genes with 5 prime UTR (the existing start codons from these genes are distinct from the begin coordinate of it. Start codons of some transcripts of gene may be missing).\t%i" % utr5prime)
        logging.info("Number of genes with 3 prime UTR (the existing stop codons from these genes are distinct from the end coordinate of it. Stop codons of some transcripts of gene may be missing).\t%i" % utr3prime)
        ...
        logging.info("Genes with unknown 3prime UTR prediction (no stop codon)\t%i\n" % noStop)
