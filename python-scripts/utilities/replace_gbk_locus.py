...
def main():
    parser = argparse.ArgumentParser(description="Script to replace locus tag in genbank records using a tab delimited mapping file (may be generated with rename fasta headsers script).")
